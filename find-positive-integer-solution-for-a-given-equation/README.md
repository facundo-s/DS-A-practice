<h2>1237. Find Positive Integer Solution for a Given Equation</h2><h3>Easy</h3><hr><div><p>Given a&nbsp;function&nbsp; <code>f(x, y)</code>&nbsp;and a value <code>z</code>, return all positive integer&nbsp;pairs <code>x</code> and <code>y</code> where <code>f(x,y) == z</code>.</p>
