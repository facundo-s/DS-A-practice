<h2>1656. Design an Ordered Stream</h2><h3>Easy</h3><hr><div><p>There is a stream of <code>n</code> <code>(id, value)</code> pairs arriving in an <strong>arbitrary</strong> order, where <code>id</code> is an integer between <code>1</code> and <code>n</code> and <code>value</code> is a string. No two pairs have the same <code>id</code>.</p>
